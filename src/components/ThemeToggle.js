...
const ThemeToggle = () => {
  ...
  return (
    <motion.button
      onClick={toggleTheme}
      className="fixed z-50 bottom-8 right-8 bg-white/10 dark:bg-gray-800/30 backdrop-blur-md rounded-full p-3 shadow-lg border border-white/20 dark:border-gray-700/30"
